...
/**
 * funciones para la muestra y carga de personas registradas
*/

function getPersonasByTipo() {
    let tiporegistro = $("#tipopersonasbusqueda").val();
    if (tiporegistro == '' || tiporegistro == null) {
        $.toast({
            heading: 'Mensaje Informativo',
            text: `Debes seleccionar un tipo de persona para búscar`,
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'warning',
            hideAfter: 5000,
        ...
        $('#personaatable').DataTable({
            ...
            "ajax": `/personas/get-personas-tipo/${tiporegistro}`,
            "columns": [
                {
                    data: 'acciones'
                }
        ...
        // $.ajax({
        //     type: "GET",
        //     url: `/personas/get-personas-tipo/${tiporegistro}`,
        //     success: function (response) {
        //         $("#resultadodebusqueda").removeClass('d-none');
        //         // $("#bodytablepersonas").html('');
        //         // response.data.forEach((e) => {
        //         //     $("#bodytablepersonas").append(`
        //         //         <tr>
        //         //             <td>${e.tipo_persona.tipo_persona}</td>
        //         //             <td>${e.nombres} ${e.apellidos}</td>
        //         //             <td>${e.documento}</td>
        //         //             <td>
        //         //                 <button class="btn btn-sm btn-info">ACCIONES</button>
        //         //             </td>
        //         //         </tr>
        //         //         `);
        //         // });
